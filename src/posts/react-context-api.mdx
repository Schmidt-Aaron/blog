...
React [context](https://reactjs.org/docs/context.html) is a newish way (officially released in 2018) to share data between a parent component and any child component, no matter how many levels down the tree the child is.
